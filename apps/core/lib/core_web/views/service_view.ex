defmodule CoreWeb.ServiceView do
  ...
  def render("index.json", %{services: services}) do
    %{
      data: render_many(services, CoreWeb.ServiceView, "service.json")
     }
  end
  ...
  def render("service.json", %{service: service}) do
    %{
      ...
      included: %{
        entities: render_many(service.entities |> Core.Repo.preload([:service]), CoreWeb.EntityView, "entity.json")
      },
      attributes: %{

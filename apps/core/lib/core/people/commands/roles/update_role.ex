defmodule Core.People.Commands.UpdateRole do
  @moduledoc false
  defstruct [
    role_uuid: "",
    name: "",
  ...
  alias Core.People.Commands.UpdateRole
...
defimpl Core.Support.Middleware.Uniqueness.UniqueFields,
  for: Core.People.Commands.UpdateRole
do
  def unique(%Core.People.Commands.UpdateRole{role_uuid: role_uuid}), do: [

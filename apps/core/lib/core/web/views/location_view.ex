defmodule Core.Web.LocationView do
  use Core.Web, :view
  ...
  def render("show.json", %{location: location}) do
    ...
    %{
     data: render_one(location, Core.Web.LocationView, "location.json")
    }
  end
  ...
  def render("location.json", %{location: location}) do
    %{
      ...
      type: "locations",
      included: %{
       zones: render_many(location.zones |> Core.Repo.preload([:location, :rooms]) , Core.Web.ZoneView, "zone.json")
      },
      attributes: %{
        name: location.name,

defmodule Core.Accounts.Commands.CreateRole do
  @moduledoc """
  Create a role
  """
    ...
    alias Core.Accounts.Commands.CreateRole
    ...
    defimpl Core.Support.Middleware.Uniqueness.UniqueFields,
      for: Core.Accounts.Commands.CreateRole
    do
      def unique(%Core.Accounts.Commands.CreateRole{role_uuid: role_uuid}), do: [

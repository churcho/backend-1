{application,credo,
             [{description,"A static code analysis tool with a focus on code consistency and teaching."},
              {modules,['Elixir.Credo','Elixir.Credo.Application',
                        ...
                        'Elixir.Credo.Check','Elixir.Credo.Check.CodeHelper',
                        ...
                        'Elixir.Credo.Execution.Monitor',
                        ...
                        'Elixir.Credo.IssueMeta','Elixir.Credo.MainProcess',
                        'Elixir.Credo.MainProcess.ConvertCliOptionsToConfig',
                        'Elixir.Credo.MainProcess.DetermineCommand',
                        'Elixir.Credo.MainProcess.HaltExecution',
                        'Elixir.Credo.MainProcess.ParseCliOptions',
                        'Elixir.Credo.MainProcess.ResolveConfig',
                        'Elixir.Credo.MainProcess.RunCommand',
                        'Elixir.Credo.MainProcess.SetDefaultCommand',
                        'Elixir.Credo.MainProcess.ValidateCliOptions',
                        'Elixir.Credo.MainProcess.ValidateConfig',
